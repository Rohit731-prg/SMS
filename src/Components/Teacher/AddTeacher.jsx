...
function AddTeacher() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setTeacherList([...TeacherList, teacherDetails]);
        dispatch(setTeacher([...TeacherList, teacherDetails]));
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className='block text-sm font-medium text-gray-700'>
                    <label className='block text-sm font-medium text-gray-700' name="gender">Gender<span className="text-red-500">*</span></label>
                    <select
                    name='gender'
                    className='mt-1 block w-full py-3 border-b-2 outline-none border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500'
                  ...
                  <div className='block text-sm font-medium text-gray-700'>
                    <label className='block text-sm font-medium text-gray-700' name="gender">Blood Group<span className="text-red-500">*</span></label>
                    <select
                    name='gender'
                    className='mt-1 block w-full py-3 border-b-2 outline-none border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500'
                    onChange={(e) => setTeacherDetails({ ...teacherDetails, bloodGroup: e.target.value })}>
                  ...
                  <div className='block text-sm font-medium text-gray-700'>
                    <label className='block text-sm font-medium text-gray-700' name="gender">Religion<span className="text-red-500">*</span></label>
                    <select
                    name='gender'
                    className='mt-1 block w-full py-3 border-b-2 outline-none border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500'
                    onChange={(e) => setTeacherDetails({ ...teacherDetails, religion: e.target.value })}>
                  ...
                  <div>
                    <label className='block text-sm font-medium text-gray-700' name="gender">Address<span className="text-red-500">*</span></label>
                    <input
